...
#define ZHIHU_API_HOST @"http://news-at.zhihu.com/api"
#define ZHIHU_API_VERSION @"4"
#define ZHIHU_API(Path) [NSString stringWithFormat:@"%@/%@/%@", ZHIHU_API_HOST, ZHIHU_API_VERSION, Path]

// 1. 启动界面图像获取
#define ZHIHU_START_IMAGE ZHIHU_API(@"start-image/480*728")

// 2. 软件版本查询

// 3. 最新消息
#define ZHIHU_LASTEST_NEWS ZHIHU_API(@"news/latest")

// 4. 消息内容获取与离线下载
#define ZHIHU_NEWS_CONTENT(id) [NSString stringWithFormat:@"%@/%@/news/%@", ZHIHU_API_HOST, ZHIHU_API_VERSION, id]
